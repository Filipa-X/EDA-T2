...
namespace image{
    ...
    Image::Image(): width(0), height(0), th_value(120), data(nullptr), regions() {

    }

    Image::Image(int w, int h): width(w), height(h), th_value(120),  data(nullptr), regions() {

    }

    Image::Image(int w, int h, uchar* _data): width(w), height(h), th_value(120), data(_data), regions() {
       threshold();
    }
